...
const websiteLatexRegex = new RegExp(/\$\$[\s\S]*?\$\$|\$.*?\$/, "g")

export const OxHugoFlavouredMarkdown: WebsiteTransformerPlugin<Partial<Options>> = (userOpts) => {
  ...
  return {
    ...
    textTransform(_ctx, src) {
      ...
      if (opts.replaceOrgLatex) {
        ...
        src = src.replaceAll(websiteLatexRegex, (value) => {
