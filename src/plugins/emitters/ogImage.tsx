...
import { FullSlug, getFileExtension, isAbsoluteURL, joinSegments, WEBSITE } from "../../util/path"
...
export const CustomOgImages: WebsiteEmitterPlugin<Partial<SocialImageOptions>> = (userOpts) => {
