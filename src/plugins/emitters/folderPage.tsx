...
import { WebsiteComponentProps } from "../../components/types"
import HeaderConstructor from "../../components/Header"
import BodyConstructor from "../../components/Body"
import { pageResources, renderPage } from "../../components/renderPage"
import { ProcessedContent, WebsitePluginData, defaultProcessedContent } from "../vfile"
...
import { defaultListPageLayout, sharedPageComponents } from "../../../website.layout"
...
async function* processFolderInfo(
  ...
  for (const [folder, folderContent] of Object.entries(folderInfo) as [
    ...
    const componentData: WebsiteComponentProps = {
      ctx,
      fileData: file.data,
      externalResources,
      cfg,
...
export const FolderPage: WebsiteEmitterPlugin<Partial<FolderPageOptions>> = (userOpts) => {
